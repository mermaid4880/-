<%@ Page Language="C#" AutoEventWireup="true" CodeFile="set_f_order.aspx.cs" Inherits="aboutOrder_set_f_order" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-280'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_equip_f&sortName=cjq_time' //数据接口
                    , cellMinWidth: 100
                    , cols: [[
                      { checkbox: true }
                      ...
                      , { field: 'PIDI', title: 'PIDI', sort: true, width: 100, align: 'center' }
                      , { field: 'PIDD', title: 'PIDD', sort: true, width: 100, align: 'center' }
                      , { field: 'PIDT', title: 'PIDT', sort: true, width: 100, align: 'center' }
                      , { field: 'F_min_kd', title: '最小阀开度', sort: true, width: 110, align: 'center' }
                      , { field: 'F_max_kd', title: '最大阀开度', sort: true, width: 110, align: 'center' }
            ...
            //设置模式
            var vjsonDate2 = [{ "id": "1", "text": "点抄阀数据" }, { "id": "01", "text": "设定阀门开度值" }, { "id": "02", "text": "进回水温差模式" }, { "id": "03", "text": "进回水均温模式" }, { "id": "04", "text": "回水温度模式" }, { "id": "11", "text": "设置阀门最大最小开度" }, { "id": "22", "text": "设置阀门滞死区" }, { "id": "33", "text": "设置阀门自检功能" }, { "id": "44", "text": "设置系统参数" }, { "id": "100", "text": "设置PIDT"}];
        ...
        layui.use('form', function () {
                ...
                if (data1.length > 0) {
                    layer.confirm("确定要进行命令下发吗？", function (index) {
                        ...
                        if (vSelected == "01") {
                            ...
                            vSelected = vSelected + "," + NumberToFormart(vText1);
                        }
            ...
            function open_orderDetail(vCommandNum, orderClass) {
                ...
                layer.open({
                    type: 2,
                    area: ['900px', '600px'],
                    content: "orderDetail.aspx?commandNum=" + vCommandNum + "&orderClass=" + orderClass,
            ...
            form.on('select(sel_setModuel)', function (data) {
                ...
                if (data) {
                    ...
                    else if (vSelectValue == "11" || vSelectValue == "44") {
                    ...
                    else if (vSelectValue == "100") {

                        $("#divSet1").css("display", "inline-block");
                        $("#divSet2").css("display", "inline-block");
                        $("#divSet3").css("display", "inline-block");
                        $("#divSet4").css("display", "inline-block");

                        $("#txtSet1").attr("lay-verify", "required");
                        $("#txtSet2").attr("lay-verify", "required");
                        $("#txtSet3").attr("lay-verify", "required");
                        $("#txtSet4").attr("lay-verify", "required");
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 200px;">
                                ...
                                <option value="2">进回水温度设置</option>
                                <option value="3">进回水平均温度设置</option>
                                <option value="4">回水温度设置</option>
                                <option value="7">目标值修正设置</option>
                                <option value="8">阀开度上下限设置</option>
                                <option value="9">滞死区设置</option>
                                </select>
			                </div>
		                </div>
