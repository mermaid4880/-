<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderDetail_house.aspx.cs" Inherits="aboutOrder_orderDetail_house" %>
        ...
        function f_init() {
            ...
            table.render({
                id: 'idTest'
                    , elem: '#idTest'
                    , height: '500'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_Server_Manual_F_info_house&sortName=center_id,mpid' //数据接口
                    , cellMinWidth: 100
                    , cols: [[
                      { checkbox: true }
                      ...
                      , { field: 'Ljkftime', title: '累计开阀时间', sort: true, width: 120, align: 'center' }
