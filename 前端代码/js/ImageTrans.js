...
ImageTrans.prototype = {
  ...
  _initContainer: function() {
	...
	this._style = { "position": style.position,  };//备份样式"overflow": style.overflow
...
ImageTrans.modes = function(){
	...
	function initImg(img, container) {
		$$D.setStyle( img, {
			position: "absolute",
			padding: 0, margin: 0, //width: "auto", height: "auto",重置样式
...
ImageTrans.transforms = {
  ...
  //根据弧度旋转
  rotate: function(radian) { this._radian = radian; parameter=radian;},
  //向左转90度
