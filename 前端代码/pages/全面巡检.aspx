            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data) {
                        ...
                        var vHtml = "<p>设备类型：";
                        for (var i = 0; i < vLen; i++) {
                            vHtml += "<input class='ever_deviceType' data='" + data[i].deviceType + "' type='checkbox' name='ck1' value='N" + data[i].id + "' style='margin-left:15px;' />" + data[i].deviceType + " ";
                        }
                        vHtml += "</p>";
                        $("#divHead2").html(vHtml);
                    }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data) {
                        ...
                        var vHtml = "<p>识别类型：";
                        for (var i = 0; i < vLen; i++) {
                            vHtml += "<input class='ever_detectionName' data='" + data[i].detectionName + "' type='checkbox'  name='ck1' value='N" + data[i].id + "'  style='margin-left:15px;'/>" + data[i].detectionName + " ";
                        }
                        vHtml += "</p>";
                        $("#divHead3").html(vHtml);
                    }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data) {
                        ...
                        var vHtml = "<p>表计类型：";
                        for (var i = 0; i < vLen; i++) {
                            vHtml += "<input class='ever_meterType' data='" + data[i].meterType + "' type='checkbox' name='ck1' value='N" + data[i].id + "' style='margin-left:15px;' />" + data[i].meterType + " ";
                        }
                        vHtml += "</p>";
                        $("#divHead4").html(vHtml);
                    }
    ...
    <form id="form1" runat="server">
        <div id="layout1">
            ...
            <div position="top" id="divHead">
                <div id="divHead0">
                    <p>
                        巡检类型：<input type="radio" style="margin-left: 15px;" disabled />例行巡检
                        <input type="radio" checked />全面巡检
                ...
                <div id="divHead5">
                    <p>
                        子巡检类型：<input type="radio" style="margin-left: 15px;" />子巡检类型1
                        <input type="radio" />子巡检类型2
                        <input type="radio" />子巡检类型3
                        <input type="radio" />子巡检类型4
                    </p>
                </div>
                <div id="divHead1"></div>
                <div id="divHead2"></div>
            ...
            <div position="center" title="任务编辑列表">
                ...
                <div class="layui-form" style="padding-top: 8px;">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                             <input type="text" class="layui-input" id="time3" placeholder="yyyy-MM-dd HH:mm:ss" style="height: 30px;line-height:30px;  ">
                        </div>
