    ...
    <script>
         ...
         $(function () {
            grid = $("#maingrid").ligerGrid({
                    columns: [
                        { display: '单位',   name: 'source', width: 200 },
                        { display: '变电站', name: 'level', width: 200 },
                        { display: '间隔电压', name: 'detail', width: 200},
                        { display: '间隔名称', name: 'time', width: 200},
                        { display: '审核状态', name: 'isDealed', width: 200 },
                        {display: '点位名称', name: 'isDealed', width: 200 },
                        { display: '短信接收人id', name: 'isDealed', width: 200},
                        { display: '发送频率（天）', name: 'isDealed', width: 200 },
                    { display: '告警通知', name: 'isDealed', width: 220}  ]
                    , pageSize: 30
                    , checkbox: true
                    , width: '100%'
         ...
         //var vList = f_getCheckedNodes("N");
            ...
            $.ajax({
                ...
                data: {
                    ...
                    , MethodUrl: "/systemAlarms?startTime=" + stratTime + "&endTime=" + endTime
                   ,token: public_token
                   ,ListName:"list"
                },
                dataType: "json",
            ...
            <div class="layui-form" style="padding-top: 8px;">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline" style="float: left; height: 30px; line-height: 30px;">
                         ...
                         <div class="layui-inline" style="float: left; height: 30px; line-height: 30px;">
                           ...
                           <label class="layui-form-label">变电站：</label>
                              <div class="layui-input-inline" style="width:150px">
                                <select name="modules">
                                    <option value="hour">请选择</option>
                                    <option value="day">3</option>
                         ...
                         <div class="layui-inline" style="float: left; height: 30px; line-height: 30px;">
                           ...
                           <label class="layui-form-label">间隔电压：</label>
                             <div class="layui-input-inline" style="width:150px">
                                <select name="modules">
                                    <option value="hour">请选择</option>
                                    <option value="day">3</option>
                         ...
                         <div class="layui-inline" style="float: left; height: 30px; line-height: 30px;">
                           ...
                           <label class="layui-form-label" style="width:100px">接收人账号：</label>
                            <div class="layui-input-inline" style="width:150px">
                                  <input type="text" class="layui-input"  value="" > 
                            </div>
                        </div>
                        ...
                        </div>                        <div class="layui-inline" style="float: left; height: 30px; line-height: 30px;">
             ...
             <div class="layui-form" style="padding-top: 8px;">
                   ...
                   <%--     <div class="layui-input-inline" style="width: 210px;">
                        ...
                        <div class="layui-input-inline" style="width: 80px">
                            <input type="button" class="layui-btn layui-btn-warm" value="删除" onclick="saveDB()"></input>
                        </div>
