<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本 Public_zgs.aspx.cs" Inherits="Organize_Public_zgs" %>
            ...
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        ...
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="zgs_name" name="zgs_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="zgs_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="zgs_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入总公司名称" autocomplete="off" class="layui-input">
                </div>
          </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 200px;">
				    <select name="jt_id@comparisonEqu" id="jt_id" lay-verify="required">
                    </select>
			    </div>
            </div>
