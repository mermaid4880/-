<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Public_dy.aspx.cs" Inherits="Organize_Public_dy" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_Public_dy_form&sortName=Dy_id&sortorder=desc' //数据接口
                    , cellMinWidth: 100
                    ...
                    , cols: [[
                      ...
                      , { field: 'Lh_name', title: '楼号名称', sort: true, width: 200, align: 'center' }
                ...
                if (enhanceForm) {
                    var Json = { "Dy_name@like": "", "createDate@greaterorequal": "" };
                ...
                $.post(
                    "../handler/select.ashx"
                    , { view: "vw_Public_lh_basic", idfield: "lh_id", textfield: "lh_name" }
                    , function (dataJson) {
                        if (dataJson) {
                            $("#lh_id").append("<option value=''>请选择</option>");
                            for (var i = 0; i < dataJson.length; i++) {
                                $("#lh_id").append("<option value=" + dataJson[i].id + ">" + dataJson[i].text + "</option>");
                            }
            ...
            $("#divAdd").on("click", function () {
                ...
                public_isAdd = true;
                LayerOpenDiv("信息添加");
                var Json = { "Dy_name@comparisonEqu": "", "lh_id@comparisonEqu": "", "Order_no": "", "CreateDate": "", "Remarks": "" };
                if (enhanceForm) {
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_Public_dy_form&FunctionID=" + Function_id;
                        layer.closeAll();
                    }
                     );
                }
        ...
        <div id="divCenterSearch" class="layui-form" >
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        <label class="layui-form-mid">单元名称：</label>
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="Dy_name" name="Dy_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="Dy_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="Dy_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入单元名称" autocomplete="off" class="layui-input">
                </div>
          </div>

           <div class="layui-form-item">
                <label class="layui-form-label">所属楼号</label>
                <div class="layui-input-inline" style="width: 200px;">
				    <select name="lh_id@comparisonEqu" id="lh_id" lay-verify="required">
                    </select>
			    </div>
            </div>
