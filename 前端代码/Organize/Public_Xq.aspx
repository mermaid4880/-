<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Public_Xq.aspx.cs" Inherits="Organize_Public_Xq" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_Public_Xq_form&sortName=Xq_id&sortorder=desc' //数据接口
                    , cellMinWidth: 100
                    , cols: [[
                      { checkbox: true }
                     , { field: 'rowId', title: '序号', sort: true, width: 80, align: 'center' }
                      , { field: 'Xq_name', title: '小区名称', sort: true, width: 200, align: 'center' }
                ...
                if (enhanceForm) {
                    var Json = { "Xq_name@like": "", "createDate@greaterorequal": "" };
            ...
            $("#divAdd").on("click", function () {
                ...
                public_isAdd = true;
                LayerOpenDiv("信息添加");
                var Json = {"Xq_name@comparisonEqu":"","Hrz_id@comparisonEqu":"","Order_no":"","CreateDate":"","Remarks":""};
                if (enhanceForm) {
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_Public_Xq_form&FunctionID=" + Function_id;
                        layer.closeAll();
                    }
                     );
                }
            ...
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        ...
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="Xq_name" name="Xq_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="Xq_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="Xq_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入小区名称" autocomplete="off" class="layui-input">
                </div>
          </div>

           <div class="layui-form-item">
                <label class="layui-form-label">所属换热站</label>
