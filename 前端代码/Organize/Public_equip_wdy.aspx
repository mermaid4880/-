<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Public_equip_wdy.aspx.cs" Inherits="Organize_Public_equip_wdy" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_equip_wdy_form&sortName=Wdy_id&sortorder=desc' //数据接口
                    , cellMinWidth: 100
            
                    , cols: [[
                      { checkbox: true }
                      , { field: 'rowId', title: '序号', sort: true, width: 80, align: 'center' }
                      , { field: 'Wdy_no', title: '温度仪编号', sort: true, width: 200, align: 'center' }
                      , { field: 'center_name', title: '采集器名称', sort: true, width: 200, align: 'center' }
                ...
                if (enhanceForm) {
                    var Json = { "Wdy_no@like": "", "createDate@greaterorequal": "" };
                ...
                $.post(
                    ...
                    , function (dataJson) {
                        if (dataJson) {
                            $("#Center_id").append("<option value=''>请选择</option>");
            ...
            $("#divAdd").on("click", function () {
                ...
                public_isAdd = true;
                LayerOpenDiv("信息添加");
                var Json = { "Wdy_no@comparisonEqu": "", "Center_id@comparisonEqu": "", "CreateDate": "", "Remarks": "" };
                if (enhanceForm) {
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_equip_wdy_form&FunctionID=" + Function_id;
                        layer.closeAll();
        ...
        <div id="divCenterSearch" class="layui-form" >
            <div class="layui-form-item">
		        <div class="layui-inline">
			        <label class="layui-form-mid">温度仪编号：</label>
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="Wdy_no" name="Wdy_no@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="Wdy_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>

           <div class="layui-form-item">
                <label class="layui-form-label">温度仪编号</label>
                <div class="layui-input-block">
                  <input type="text" name="Wdy_no@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入温度仪编号" autocomplete="off" class="layui-input">
                </div>
          </div>
...
<%--            <div class="layui-form-item">
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 200px;">
				    <input type="text" name="CreateDate" id="CreateDateForm" autocomplete="off" class="layui-input" dateRange="1" placeholder=" 请选择时间 "/>
			    </div>
            </div>
