<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Public_core_jz.aspx.cs" Inherits="Organize_Public_core_jz" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_core_jz_form&sortName=jz_name' //数据接口
                    , cellMinWidth: 100
                    , cols: [[
                      { checkbox: true }
                      , { field: 'jz_name', title: '机组名称', sort: true, width: 200, align: 'center' }
                      , { field: 'Hrz_name', title: '换热站名称', sort: true, width: 200, align: 'center' }
                      , { field: 'last_time', title: '最近上线时间', sort: true, width: 160, align: 'center' }
                      , { field: 'createDate', title: '创建时间', sort: true, width: 300, align: 'center' }
                    ]]
                    , page: true //开启分页
                ...
                if (enhanceForm) {
                    var Json = { "jz_name@like": "测试", "createDate@greaterorequal": "2017-1-1" };
                ...
                $.post(
                    "../handler/select.ashx"
                    , { view: "vw_Public_hrz_basic", idfield: "Hrz_id", textfield: "Hrz_name" }
                    , function (dataJson) {
                        if (dataJson) {
                            $("#hrz_id").append("<option value=''>请选择</option>");
                            for (var i = 0; i < dataJson.length; i++) {
                                $("#hrz_id").append("<option value=" + dataJson[i].id + ">" + dataJson[i].text + "</option>");
                            }
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_core_jz_form&FunctionID=" + Function_id;
        ...
        <div id="divCenterSearch" class="layui-form" >
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        <label class="layui-form-mid">机组名称：</label>
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="jz_name" name="jz_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="jz_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" />
              
                </div>
           </div>

           <div class="layui-form-item">
                <label class="layui-form-label">机组名称</label>
                <div class="layui-input-block">
                  <input type="text" name="jz_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入机组名称" autocomplete="off" class="layui-input"/>
                </div>
          </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 200px;">
				    <select name="hrz_id@comparisonEqu" id="hrz_id" lay-verify="required">
                    </select>
			    </div>
            </div>
