<%@ Page Language="C#" AutoEventWireup="true" CodeFile="public_hrz.aspx.cs" Inherits="Organize_public_hrz" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_Public_hrz_form&sortName=Hrz_id&sortorder=desc' //数据接口
                    , cellMinWidth: 100
                 
                    , cols: [[
                      { checkbox: true }
                      , { field: 'Hrz_name', title: '换热站名称', sort: true, width: 200, align: 'center' }
                      , { field: 'k_name', title: '管理站名称', sort: true, width: 200, align: 'center' }
                ...
                if (enhanceForm) {
                    var Json = { "hrz_name@like": "", "createDate@greaterorequal": "" };
                ...
                $.post(
                    "../handler/select.ashx"
                    , { view: "vw_Public_k_basic", idfield: "k_id", textfield: "k_name" }
                    , function (dataJson) {
                        if (dataJson) {
                            $("#k_id").append("<option value=''>请选择</option>");
                            for (var i = 0; i < dataJson.length; i++) {
                                $("#k_id").append("<option value=" + dataJson[i].id + ">" + dataJson[i].text + "</option>");
                            }
                        }
                    }, "json");
                //
            ...
            $("#divAdd").on("click", function () {
                ...
                public_isAdd = true;
                LayerOpenDiv("信息添加");
                var Json = { "hrz_name@comparisonEqu": "", "k_id@comparisonEqu": "", "Order_no": "", "CreateDate": "", "Remarks": "" };
                if (enhanceForm) {
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_Public_hrz_form&FunctionID="+Function_id;
                        layer.closeAll();
                    }
                     );
                }
        ...
        <div id="divCenterSearch" class="layui-form" >
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        <label class="layui-form-mid">换热站名称：</label>
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="hrz_name" name="hrz_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="hrz_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>

           <div class="layui-form-item">
                <label class="layui-form-label">换热站名称</label>
                <div class="layui-input-block">
                  <input type="text" name="hrz_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入换热站名称" autocomplete="off" class="layui-input">
                </div>
          </div>

           <div class="layui-form-item">
                <label class="layui-form-label">所属管理站</label>
                <div class="layui-input-inline" style="width: 200px;">
				    <select name="k_id@comparisonEqu" id="k_id" lay-verify="required">
                    </select>
			    </div>
            </div>
...
<%--           <div class="layui-form-item">
           ...
           <div class="layui-form-item layui-form-text">
              ...
              <div class="layui-input-inline" style="width: 300px;">
                <textarea name="Remarks" placeholder="请输入内容" lay-verify="contact" class="layui-textarea"></textarea>
              </div>
            </div>
