<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Public_yh_Gl.aspx.cs" Inherits="Organize_Public_yh_Gl" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_public_house_form_1&sortName=house_id&sortorder=desc' //数据接口
                    , cellMinWidth: 100

                    , cols: [[
                      { checkbox: true }
                      , { field: 'rowId', title: '序号', sort: true, width: 80, align: 'center' }
                      , { field: 'house_name', title: '用户名称', sort: true, width: 200, align: 'center' }
                      , { field: 'Dy_name', title: '单元名称', sort: true, width: 200, align: 'center' }
                      , { field: 'lc', title: '楼层', sort: true, width: 200, align: 'center' }
                      , {field:'mph',title:'门牌号',sort:true,width:200,align:'center'}
                    ]]
                    , page: true //开启分页
                ...
                $.post(
                    "../handler/select.ashx"
                    , { view: "vw_public_dy_basic", idfield: "dy_id", textfield: "dy_name" }
                    , function (dataJson) {
                        if (dataJson) {
                            $("#belongId").append("<option value=''>请选择</option>");
                            for (var i = 0; i < dataJson.length; i++) {
                                $("#belongId").append("<option value=" + dataJson[i].id + ">" + dataJson[i].text + "</option>");
                            }
            ...
            $("#divAdd").on("click", function () {
                ...
                public_isAdd = true;
                LayerOpenDiv("信息添加");
                var Json = { "house_name@comparisonEqu": "", "belongId@comparisonEqu": "", "mph": "", "lc": "" };
                if (enhanceForm) {
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_public_house_form_1&FunctionID=" + Function_id;
                        layer.closeAll();
                    }
                     );
                }
        ...
        <div id="divCenterSearch" class="layui-form" >
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        <label class="layui-form-mid">住户名称：</label>
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="house_name" name="house_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		<%--        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="house_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="house_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入住户名称" autocomplete="off" class="layui-input">
                </div>
          </div>
          <div class="layui-form-item">
                <label class="layui-form-label">所属单元</label>
                <div class="layui-input-inline" style="width: 200px;">
				    <select name="belongId@comparisonEqu" id="belongId" lay-verify="required">
                    </select>
			    </div>
            </div>
                     <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="lc"    style="width: 200px;" placeholder="请输入楼层名称" autocomplete="off" class="layui-input">
                </div>
          </div>
            <div class="layui-form-item">
                <label class="layui-form-label">门牌号</label>
                <div class="layui-input-block">
                  <input type="text" name="mph"  style="width: 200px;" placeholder="请输入门牌号名称" autocomplete="off" class="layui-input">
                </div>
          </div>
