<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Public_k.aspx.cs" Inherits="Organize_Public_k" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_Public_k_form&sortName=K_id&sortorder=desc' //数据接口
                    , cellMinWidth: 100
                ...
                //以下是初始化 例如默认值 加载下来框等
                if (enhanceForm) {
                    var Json = { "zgs_name@like": "", "createDate@greaterorequal": "" };
                ...
                $.post(
                    "../handler/select.ashx"
                    , { view: "vw_Public_fgs_basic", idfield: "fgs_id", textfield: "fgs_name" }
                    , function (dataJson) {
                        if (dataJson) {
                            $("#fgs_id").append("<option value=''>请选择</option>");
                            for (var i = 0; i < dataJson.length; i++) {

                                $("#fgs_id").append("<option value=" + dataJson[i].id + ">" + dataJson[i].text + "</option>");
                            }
            ...
            $("#divAdd").on("click", function () {
                ...
                public_isAdd = true;
                LayerOpenDiv("信息添加");
                var Json = { "k_name@comparisonEqu": "", "fgs_id@comparisonEqu": "", "Order_no": "", "CreateDate": "", "Remarks": "" };
                if (enhanceForm) {
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_Public_k_form&FunctionID=" + Function_id;
                        layer.closeAll();
                    }
                     );
                }
        ...
        <div id="divCenterSearch" class="layui-form" >
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        <label class="layui-form-mid">管理站名称：</label>
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="k_name" name="k_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="k_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>

           <div class="layui-form-item">
                <label class="layui-form-label">管理站名称</label>
                <div class="layui-input-block">
                  <input type="text" name="k_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入管理站名称" autocomplete="off" class="layui-input">
                </div>
          </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 200px;">
				    <select name="fgs_id@comparisonEqu" id="fgs_id" lay-verify="required">
                    </select>
			    </div>
            </div>
            <div class="layui-form-item">
