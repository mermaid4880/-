<%@ Page Language="C#" AutoEventWireup="true" CodeFile="public_lh.aspx.cs" Inherits="Organize_public_lh" %>
        ...
        $(function () {
            ...
            layui.use(['table', 'element', 'laydate'], function () {
                ...
                table.render({
                    ...
                    , elem: '#idTest'
                    , height: 'full-160'
                    , url: '../handler/Grid.ashx?methodType=V&view=vw_Public_lh_form&sortName=Lh_id&sortorder=desc' //数据接口
                    , cellMinWidth: 100
                ...
                //以下是初始化 例如默认值 加载下来框等
                if (enhanceForm) {
                    var Json = { "Lh_name@like": "", "createDate@greaterorequal": "" };
                ...
                $.post(
                    "../handler/select.ashx"
                    , { view: "vw_Public_xq_basic", idfield: "Xq_id", textfield: "Xq_name" }
                    , function (dataJson) {
                        if (dataJson) {
                            $("#Xq_id").append("<option value=''>请选择</option>");
                            for (var i = 0; i < dataJson.length; i++) {
                                $("#Xq_id").append("<option value=" + dataJson[i].id + ">" + dataJson[i].text + "</option>");
                            }
            ...
            $("#divAdd").on("click", function () {
                ...
                public_isAdd = true;
                LayerOpenDiv("信息添加");
                var Json = { "Lh_name@comparisonEqu":"","Xq_id@comparisonEqu":"","Order_no":"","CreateDate":"","Remarks":"" };
                if (enhanceForm) {
            ...
            $("#divExport").on("click", function () {
                ...
                if (tableRowsCount <= 0) {
                    ...
                    layer.confirm(vMsg, {
                        ...
                        document.getElementById("1").src = "../handler/export_sql.ashx?gridname=&view=vw_Public_lh_form&FunctionID=" + FunctionID;
                        layer.closeAll();
                    }
                     );
                }
        ...
        <div id="divCenterSearch" class="layui-form" >
            <div class="layui-form-item">
		        ...
		        <div class="layui-inline">
			        <label class="layui-form-mid">楼名称：</label>
			        <div class="layui-input-inline" style="width: 120px;">
				        <input type="text" id="Lh_name" name="Lh_name@like" autocomplete="off" class="layui-input"/>
			        </div>
		        </div>
		        <div class="layui-inline">
        ...
        <div id="divFormOpen" style="display:none;padding-top:20px"  class="layui-form" >
            ...
            <div class="layui-form-item" style="display:none">
                ...
                <div class="layui-input-block">
                  <input type="text" name="Lh_id@identity@comparisonNoEqu"   style="width: 200px;" placeholder="数据的id"  class="layui-input" >
                </div>
           </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="Lh_name@comparisonEqu"   lay-verify="required" style="width: 200px;" placeholder="请输入楼名称" autocomplete="off" class="layui-input">
                </div>
          </div>
           ...
           <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 200px;">
				    <select name="Xq_id@comparisonEqu" id="Xq_id" lay-verify="required">
                    </select>
			    </div>
            </div>
